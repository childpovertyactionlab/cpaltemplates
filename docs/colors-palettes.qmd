...
| `view_all_palettes()` | Display all available palettes | Visual grid display | Choosing the right palette |
| `view_palette()` | Interactive palette explorer | Interactive display | Detailed palette exploration |
| `cpal_display_palettes()` | Show specific palettes with hex codes | Visual display | Reference and documentation |
...
- **`view_all_palettes()`**: Grid layout showing every palette, perfect for comparison 
- **`view_palette()`**: Interactive tool with color codes and accessibility information 
- **`cpal_display_palettes()`**: Clean display with hex codes, ideal for documentation
